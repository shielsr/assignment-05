"""
Django settings for fanfic_site project.
...
SECRET_KEY = 'django-insecure-#dk$ibfx6*%u^011*!&_-o$x(uqua9)_rl&zc_5c2=!_%x%()='
...
WSGI_APPLICATION = 'fanfic_site.wsgi.application'
