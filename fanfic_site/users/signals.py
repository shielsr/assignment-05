from django.db.models.signals import post_save  # This gets fired whenever an instance is saved
...
def create_profile(sender, instance, created, **kwargs):
    if created:
        Profile.objects.create(user=instance)  # create and save to the db the new profile instance